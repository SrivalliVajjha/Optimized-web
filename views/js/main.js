  ...
  function changePizzaSizes(size) {
      switch(size){
          ...
          case "3":
              newwidth=50;
              break;
          default:console.log("bug in size changer!!!");
      }
      var i,rCon=document.getElementsByClassName("randomPizzaContainer");
    for (i = 0; i < rCon.length; i++) {
     rCon[i].style.width = newwidth + "%";
    }
...
function updatePositions() {
  ...
  var items = document.querySelectorAll('.mover'),i;
